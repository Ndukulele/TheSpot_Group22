    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td class="auto-style3">
                ...
                <br />
                <asp:GridView ID="gdOrderStatus" runat="server" ShowFooter="True" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" ForeColor="Blue" HorizontalAlign="Center" OnRowDeleting="gdOrderStatus_RowDeleting">
