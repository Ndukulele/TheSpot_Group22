<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerSite.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="TheSpotGroup22.Cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div align="center">
        ...
        <br /><br />
        <asp:GridView ID="gvSCart" runat="server" AutoGenerateColumns="False" BackColor="#FF3300" Font-Bold="True" Height="70px" ShowFooter="True" Width="1100px" EmptyDataText="No Data" DataKeyNames="productId" OnRowDeleting="gvSCart_RowDeleting">
            <Columns>
        ...
        <br />
        <br />
        <asp:Button ID="btnCheckOut" runat="server" BorderColor="#FF9900" BackColor="#CC0099" Font-Bold="True" Text="Check Out" Width="103px" OnClick="btnCheckOut_Click" /><br />
