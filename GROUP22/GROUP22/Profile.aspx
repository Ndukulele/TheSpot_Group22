<%@ Page Title="" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="GROUP22.Profile" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox class="form-control" ID="txtDBirth" runat="server"  TextMode="Date">></asp:TextBox>
                                    </div>
                                    <h2>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group d-grid g-2">
                                        <asp:Button class="btn btn-primary btn-block" ID="btnUpdate" runat="server" Text="Update" />
                                    </div>
