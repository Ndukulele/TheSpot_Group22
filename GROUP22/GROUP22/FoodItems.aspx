<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerSite.Master" AutoEventWireup="true" CodeBehind="FoodItems.aspx.cs" Inherits="TheSpotGroup22.FoodItems" %>
        ...
        <tr>
            <td>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnAddToCart" runat="server" Text="Add To Cart" BackColor="OrangeRed" Style="border: solid 1px #ddd" Height="40px" Width="200px" OnClick="btnAddToCart_Click" />
                        </td>
                    </tr>
                </table>
